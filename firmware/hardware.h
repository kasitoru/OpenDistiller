...
// Датчики
#define HW_SENSOR_1_BIT      PC0
#define HW_SENSOR_1_PIN      PINC
#define HW_SENSOR_1_DDR      DDRC
#define HW_SENSOR_1_PORT     PORTC

#define HW_SENSOR_2_BIT      PC1
#define HW_SENSOR_2_PIN      PINC
#define HW_SENSOR_2_DDR      DDRC
#define HW_SENSOR_2_PORT     PORTC

#define HW_SENSOR_3_BIT      PC2
#define HW_SENSOR_3_PIN      PINC
#define HW_SENSOR_3_DDR      DDRC
#define HW_SENSOR_3_PORT     PORTC

#define HW_SENSOR_4_BIT      PD3
#define HW_SENSOR_4_PIN      PIND
